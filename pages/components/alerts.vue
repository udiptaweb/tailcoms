...
<div class="w-full flex flex-col justify-start gap-y-2 bg-white dark:bg-gray-800 h-full p-4">
  <h1 class="text-2xl font-semibold tracking-widest text-gray-700 rounded-lg dark-mode:text-white">Alerts</h1>
  <p class="text-gray-700">Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.</p>
  <h2 class="text-xl font-semibold tracking-widest text-gray-700 rounded-lg dark-mode:text-white">Examples</h2>
   <code-and-preview :code="alert1"></code-and-preview>
   <code-and-preview :code="alert2"></code-and-preview>
   <code-and-preview :code="alert3"></code-and-preview>
   <code-and-preview :code="alert4"></code-and-preview>
   <code-and-preview :code="alert5"></code-and-preview>
   <code-and-preview :code="alert6"></code-and-preview>
   <code-and-preview :code="alert7"></code-and-preview>
   <code-and-preview :code="alert8"></code-and-preview>
</div>
</template>
...
export default {
  ...
  computed:{
    alert8(){
      return `<div class="bg-red-50 border-l-4 border-red-400 text-red-700 p-4" role="alert">
          <p class="font-bold">Danger!!</p>
          <p>Lorem ipsum dolor sit amet, consectetur adip!.</p>
        </div>`;
    },
    alert7(){
      return `<div class="bg-green-50 border-l-4 border-green-400 text-green-700 p-4" role="alert">
          <p class="font-bold">Success!!</p>
          <p>Lorem ipsum dolor sit amet, consectetur adip!.</p>
        </div>`;
    },
    alert6(){
      return `<div class="bg-blue-50 border-l-4 border-blue-400 text-blue-700 p-4" role="alert">
          <p class="font-bold">Info</p>
          <p>Lorem ipsum dolor sit amet, consectetur adip!.</p>
        </div>`;
    },
    alert5(){
      return `<div class="bg-yellow-50 border-l-4 border-yellow-400 text-yellow-700 p-4" role="alert">
          <p class="font-bold">Warning</p>
          <p>Lorem ipsum dolor sit amet, consectetur adip!.</p>
        </div>`;
    },
    alert4(){
      return `<div class="bg-red-50 rounded text-red-900 px-4 py-3" role="alert">
          <div class="flex">
            <div>
    ...
    alert3(){
      return `<div class="bg-yellow-50 rounded text-yellow-900 px-4 py-3" role="alert">
          <div class="flex">
            <div>
    ...
    alert2(){
      return `<div class="bg-green-50 rounded text-green-900 px-4 py-3" role="alert">
          <div class="flex">
            <div>
    ...
    alert1(){
      return `<div class="bg-blue-50 rounded text-blue-900 px-4 py-3" role="alert">
          <div class="flex">
            <div>
